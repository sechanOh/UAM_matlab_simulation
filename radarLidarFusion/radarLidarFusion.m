...
% https://kr.mathworks.com/help/uav/ug/lidar-and-radar-fusion-in-an-urban-air-mobility-scenario.html

% Check requirements
required = ["Lidar Toolbox", "Radar Toolbox", "Sensor Fusion and Tracking Toolbox", "UAV Toolbox"];
